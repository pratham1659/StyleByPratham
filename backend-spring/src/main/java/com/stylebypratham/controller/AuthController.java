...
import com.stylebypratham.request.LoginRequest;
import com.stylebypratham.response.AuthResponse;
import com.stylebypratham.service.CartService;
import com.stylebypratham.service.CustomUserDetails;
...
public class AuthController {
    ...
    private Authentication authenticate(String username, String password) {
        ...
        if (userDetails == null) {
            System.out.println("Login userDetails - null " + userDetails);
            throw new BadCredentialsException("Invalid Username or Password");
        }
        if (!passwordEncoder.matches(password, userDetails.getPassword())) {
            System.out.println("Login userDetails - password not match " + userDetails);
            throw new BadCredentialsException("Invalid username or password");
        }
