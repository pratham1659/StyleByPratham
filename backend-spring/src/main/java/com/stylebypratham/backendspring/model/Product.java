...
public class Product {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(brand, category, color, description, discountedPercent, discountedPrice, id, imageUrl,
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(brand, other.brand) && Objects.equals(category, other.category)
                ...
                && discountedPercent == other.discountedPercent && discountedPrice == other.discountedPrice
